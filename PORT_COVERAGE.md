...
| `Elemental` ELECTRIC-style resistance halving (`Property.ELECTRIC` lightning family) | - | Not ported: the buff pipeline models immunities only. Recorded by `MONSTER_ANALYSIS_SLIME_CAUSTIC_DM100_ELEMENTAL.md`. |
