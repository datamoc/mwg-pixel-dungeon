...
| Controls/log | Original toolbar.png frames and bag/search/wait icons, four item slots, bottom-right grouped layout, log above controls; separate top-right version/floor/key/menu HUD | Fixed actions replace assignable quickslots; extra actions use an expandable menu. Cleric special uses a wand placeholder because this checkout predates the tome asset. Keyboard hint line hidden |
