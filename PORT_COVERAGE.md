...
| `Property.BOSS`/`Property.MINIBOSS` membership (eye/warlock/pylon; elemental/eye/warlock) | `actor-rules.mwl` flag sets | **Ported 2026-09-19**: both sets were missing real holders, starving them of every downstream rule (wealth rolls, execute exclusions, aggression, multiplicity/ratmogrify exclusion, paralysis immunity, spawn flags). Unported CrystalSpire/FungalCore/GnollGeomancer and CrystalGuardian/FungalSentry/GnollSapper omitted. |
