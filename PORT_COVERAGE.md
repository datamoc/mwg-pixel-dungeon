...
| Piranha kill tally (`Statistics.piranhasKilled`, the kill-count badge) | - | Not ported: no piranha badge rows exist. Stats, meat loot, water rules, and the FishingSpear hook are all real. Recorded by `MONSTER_ANALYSIS_PIRANHA_STATUE_MIMIC_WRAITH.md`. |
