...
import { CLASS_TALENTS, TALENT_TIERS, armorTalentDefinitions, subclassTalentDefinitions, type TalentDefinition } from '../../talents';
...
import { CLASS_ARMOR_ID_BY_CLASS, isClassArmorId } from '../../items/catalog';
...
/** DungeonScene methods, moved verbatim from `dungeonScene.ts` (group `part10`). Each takes the scene as `this`;
 * `dungeonScene.ts` merges them back onto the class prototype. */
export const part10Methods = {
