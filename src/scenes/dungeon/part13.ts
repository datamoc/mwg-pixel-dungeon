...
/** DungeonScene methods, moved verbatim from `dungeonScene.ts` (group `part13`). Each takes the scene as `this`;
 * `dungeonScene.ts` merges them back onto the class prototype. */
export const part13Methods = {
	/**
	...
	equipWand(this: DungeonScene): void {
