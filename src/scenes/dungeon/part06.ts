...
import { NEGATIVE_BUFFS, addBuff, reigniteBuff, rollDamage, rollHit, setBleeding, type BuffId, type Creature, type GroundItem, type Step } from '../../combat';
...
/** DungeonScene methods, moved verbatim from `dungeonScene.ts` (group `part06`). Each takes the scene as `this`;
 * `dungeonScene.ts` merges them back onto the class prototype. */
export const part06Methods = {
