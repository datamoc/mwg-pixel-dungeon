...
import { confirmDisintegrationWand, livingEarthZapRange, useDisintegrationWand, wandChargesPerCast, wandDamageRange, wandTargetRange, type DisintegrationWandScene } from '../../items/wands';
...
import { EMPOWERING_SCROLLS_BONUS, arcaneVisionDuration, canImproviseProjectile, enragedCatalystBonus, ironStomachReduction, monasticVigorShield, preservationChance, projectileMomentumBonus } from '../../talentEffects';
...
import { BUFF_DURATION, addBuff, rollHit, tickBuffs, type Creature, type Step } from '../../combat';
import { tickMonsterTurnEnd } from '../../simulation/buffs';
import { isUndeadOrDemonic } from '../../monsters';

/** DungeonScene methods, moved verbatim from `dungeonScene.ts` (group `part04`). Each takes the scene as `this`;
 * `dungeonScene.ts` merges them back onto the class prototype. */
export const part04Methods = {
	/**
