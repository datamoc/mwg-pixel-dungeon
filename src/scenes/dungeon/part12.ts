...
import { EMBERS, FLOOR, GRASS, HIGH_GRASS, TILE } from '../../dungeonConstants';
import { BUFF_DURATION, addBuff, rollDamage, setBleeding, type Creature, type Step } from '../../combat';
...
/** DungeonScene methods, moved verbatim from `dungeonScene.ts` (group `part12`). Each takes the scene as `this`;
 * `dungeonScene.ts` merges them back onto the class prototype. */
export const part12Methods = {
	/**
