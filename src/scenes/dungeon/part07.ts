...
import { addBuff, reigniteBuff, rollDamage, rollHit, setBleeding, type Creature, type Step } from '../../combat';
import { IMMOVABLE_KINDS, liveStats } from '../../monsters';

/** DungeonScene methods, moved verbatim from `dungeonScene.ts` (group `part07`). Each takes the scene as `this`;
 * `dungeonScene.ts` merges them back onto the class prototype. */
export const part07Methods = {
	/**
