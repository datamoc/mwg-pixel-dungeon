...
import { DOOR, DOOR_CLOSED, FLOOR, GRASS, HIGH_GRASS, ITEM_FRAME, TERRAIN_FRAME, TILE, WALL, WATER, type GroundItemKind } from '../../dungeonConstants';
...
/** DungeonScene methods, moved verbatim from `dungeonScene.ts` (group `part02`). Each takes the scene as `this`;
 * `dungeonScene.ts` merges them back onto the class prototype. */
export const part02Methods = {
