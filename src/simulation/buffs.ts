...
export const BUFF_DURATION: Record<BuffId, number> = {
	...
	chill: 10,
	//Frost.DURATION (Frost.java): the frozen/paralysed state lasts ten turns.
	frost: 10,
...
export const NEGATIVE_BUFFS: ReadonlySet<BuffId> = new Set<BuffId>([
	'poison', 'burning', 'bleeding', 'cripple', 'weakness', 'vulnerable', 'paralysis', 'roots', 'terror', 'amok', 'aggression', 'ooze', 'charm', 'degrade', 'daze', 'chill', 'frost', 'hex',
]);
