...
export type FreeAction = 'examine' | 'talents' | 'buyHeal' | 'buyId' | 'sellFood' | 'buyback' | 'save' | 'load' | 'preparation';
...
export function planHeroAction(action: string, paralysed: boolean, turnCostMod: number = 1): HeroActionPlan {
	...
	switch (action) {
		...
		case 'examine': case 'talents': case 'buyHeal': case 'buyId': case 'sellFood': case 'buyback': case 'save': case 'load': case 'preparation':
